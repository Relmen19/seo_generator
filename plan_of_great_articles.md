...
### Prompt 8 — UI декомпозиция admin_simple (L) ✅ closed (7131f35)
...
### Prompt 12 — Research progress UI + Prune phase (M) ✅ closed (75ad04d)
...
### Prompt 17 — Метрики стоимости research до/после (S) ✅ closed (4222a86)
