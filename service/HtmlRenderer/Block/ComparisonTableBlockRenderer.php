...
class ComparisonTableBlockRenderer extends AbstractBlockRenderer
{
    ...
    public function getCss(): string
    {
        return '.block-comparison { }'
            ...
            . "\n" . '.cmp-tab-btn { flex:1 1 auto; min-width:120px; max-width:260px; padding:10px 16px; border:none; background:transparent; font-family:var(--fh); font-size:13px; font-weight:600; color:var(--muted); cursor:pointer; border-radius:10px; transition:all .25s; white-space:normal; line-height:1.3; text-align:center; word-break:break-word; hyphens:auto }'
