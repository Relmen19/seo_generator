...
class SparkMetricsBlockRenderer extends AbstractBlockRenderer
{
    ...
    public function getCss(): string
    {
        return '@keyframes spPulse{0%,100%{r:3;opacity:.3}50%{r:7;opacity:0}}'
            ...
            . "\n" . '.sp-card{padding:20px 18px 16px;border-radius:16px;background:rgba(255,255,255,.55);backdrop-filter:blur(12px);border:1px solid var(--color-border);transition:all .35s;cursor:pointer;overflow:hidden}'
            ...
            . "\n" . '.sp-card.is-active{border-color:var(--sp-c,var(--color-accent));box-shadow:0 0 0 2px var(--sp-c,var(--color-accent)),0 10px 36px rgba(37,99,235,.1)}'
            ...
            . "\n" . '.sp-trend{display:inline-flex;align-items:center;gap:2px;padding:3px 9px;border-radius:100px;font-family:var(--type-font-heading);font-size:10.5px;font-weight:700}'
            ...
            . "\n" . '.sp-val{font-family:var(--type-font-heading);font-size:1.6rem;font-weight:900;color:var(--color-text);letter-spacing:-1px;line-height:1}'
            . "\n" . '.sp-val small{font-size:.45em;font-weight:500;color:var(--color-text-3);margin-left:2px}'
            . "\n" . '.sp-name{font-size:12.5px;color:var(--color-text-3);margin-top:2px;font-weight:500}'
            ...
            . "\n" . '.sp-area{opacity:.12}'
            . "\n" . '.sp-dot{fill:var(--color-bg);stroke-width:2;filter:drop-shadow(0 1px 3px rgba(0,0,0,.15))}'
            ...
            . "\n" . '.sp-detail-inner{padding:14px 18px;border-radius:12px;background:rgba(255,255,255,.45);border:1px solid var(--color-border);backdrop-filter:blur(6px)}'
            . "\n" . '[data-theme="dark"] .sp-detail-inner{background:rgba(255,255,255,.03)}'
            . "\n" . '.sp-detail-pair{display:flex;justify-content:space-between;align-items:center;padding:4px 0;font-size:13px;color:var(--color-text-2)}'
            . "\n" . '.sp-detail-pair+.sp-detail-pair{border-top:1px solid var(--color-border)}'
            . "\n" . '.sp-detail-pair span:last-child{font-family:var(--type-font-heading);font-weight:700;color:var(--color-text)}'
