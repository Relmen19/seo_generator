...
class NavbarComponent implements ComponentInterface
{
    ...
    {
        return '.navbar { position:fixed; top:0; left:0; right:0; z-index:200; background:rgba(248,250,252,.82); backdrop-filter:blur(24px) saturate(180%); -webkit-backdrop-filter:blur(24px) saturate(180%); border-bottom:1px solid var(--border); transition:box-shadow .3s,background .4s }'
