        ...
        return <<<'JSON'
{
  ...
  "segments": [
    // От 2 до 6 сегментов. Типы и поля:
  ...
  "image_captions": {
    // Короткие подписи (≤150 символов) для картинок блоков — ключ это block_id из контекста.
    // Подпись НЕ пересказывает картинку, а усиливает интерес к блоку.
